...
<body class="bg-c">
					...
					<tbody id="tb-cus">
						<tr>
							...
							<td><button idfield="id" onclick="modifyById(this)"
									class="btn btn-sm btn-default">修改开发信息</button></td>
						</tr>
					</tbody>
				</table>
	...
	<script type="text/javascript">
		...
		//查询
		function read(curr) {
			$.post("mycrm/Custominfo/listDeve", {				
				curr : curr,
				limit : "10"
			}, function(data) {
		...
		function modifyById(obj) {
			...
			$.post("mycrm/Custominfo/selectCinfoById", {
				id : id
			}, function(data) {
		...
		function openPage(cus) {
			layer.open({
				...
				success : function(layero, index) {
					...
					body.contents().find("#statu").val(cus.statu);
					body.contents().find("#plandate").val(fmtDate(cus.plandate));
					body.contents().find("#mark").val(cus.mark);
