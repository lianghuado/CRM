...
<body class="bg-c">
				...
				<table class="table table-striped">
					...
					<tbody id="tb-emp">
						<tr>
							...
							<td><button idfield="id" onclick="deleteById(this)" class="btn btn-sm btn-default">删除</button></td>	
						</tr>
					</tbody>
				</table>
	...
	<script type="text/javascript">
		...
		function deleteById(obj){
			...
			$.post("mycrm/Employee/delAdmin",{id:id},function(data){
				if(data==1){
					layer.alert("删除成功")
					read(1);
				}else{
