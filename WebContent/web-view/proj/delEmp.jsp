...
<body class="bg-c">
				...
				<table class="table table-striped">
					...
					<tbody id="tb-emp">
						<tr>
							...
							<td><button idfield="id" onclick="deleteById(this)" class="btn btn-sm btn-default">离职</button></td>	
						</tr>
					</tbody>
				</table>
	...
	<script type="text/javascript">
		...
		function read(curr) {
			//alert($("#sex").val())
			$.post("mycrm/Employee/listCommEmp", {				
				curr : curr,
				limit : "6"
			}, function(data) {				
		...
		function deleteById(obj){
			...
			$.post("mycrm/Employee/delCommEmp",{id:id},function(data){
				if(data=="success"){
					layer.alert("删除成功")
					read(1);
				}else{
